...
function Divisions() {
  ...
  const [showCreatePersonnelModal, setShowCreatePersonnelModal] =
    useState(false);
  ...
  return (
    <Container fluid className="dashboard">
      <CreatePesonnelModal
        ...
        setShowCreatePersonnelModal={setShowCreatePersonnelModal}
        showCreatePersonnelModal={showCreatePersonnelModal}
      />
      <CreateDivisionModal
